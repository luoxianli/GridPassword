...
import com.kayak.gridpasswordview.imebugfixer.ImeDelBugFixedEditText;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
	...
	private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		// if (textColor == null)
		// textColor =
		// ColorStateList.valueOf(getResources().getColor(android.R.color.primary_text_light));
	...
	private ImeDelBugFixedEditText.OnDelKeyEventListener onDelKeyEventListener = new ImeDelBugFixedEditText.OnDelKeyEventListener() {
		...
		public void onDeleteClick() {
			Logger.d("onDeleteClick" + viewArr);
